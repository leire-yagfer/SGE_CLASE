...
'''
Mutable: Puedes modificar, agregar o eliminar elementos después de su creación.
Ordenadas: Mantienen el orden de los elementos según cómo se añaden.
Permiten duplicados: Puedes tener elementos repetidos en una lista.
