...
#lo de la izquierda es la clave (key) y lo de la derecha es el valor (value)
...
# Ordenación: se usa la operación items que devuelve el conjunto de claves y valores --> se ordena en función de la clave
