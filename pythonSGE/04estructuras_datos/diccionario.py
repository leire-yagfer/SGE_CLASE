...
print(type(my_dict)) #imprime el tipo de dato de my_dict
print(my_dict)

# Insertar elemento: acceder al dato que queremos insertar, por clave
print(my_dict["name"]) # acceso --> lo escibe en la terminal
...
# Ordenación (por clave): se usa la operación items que devuelve el conjunto de claves y valores
