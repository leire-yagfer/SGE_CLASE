...
# Uso de lambda con filter para obtener los números pares
...
#3. Elevar cada número de una lista al cuadrado.
# Lista de números
numeros = [1, 2, 3, 4, 5]

# Uso de lambda con map para elevar cada número al cuadrado
cuadrados = list(map(lambda x: x ** 2, numeros))
