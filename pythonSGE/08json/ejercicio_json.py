...
json_file = "08json\prueba.json"

with open(json_file, "w") as jsonD:
    json.dump(data, jsonD) # json.dump convierte el diccionario en formato JSON y lo escribe en un archivo de texto
    
with open(json_file, "r") as jsonD:
    print(jsonD.read())
