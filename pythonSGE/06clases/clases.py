...
#interactuar con los parámetros de la clase (name, age...), que son propiedades de la clase
    ...
    def print(self):
        print(f"función print: \n  Nombre: {self.name} | Apellidos: {self.surname} | Edad: {self.age} | Languages: {self.languages}")


# Instanciar la clase/crear objeto:
my_programmer = Programmer("Prueba", 54, ["Python", "Java", "Javascript"]) #aquí no puedo poner apellido, sino que tiene que ser en el propio atributo surname o sino inicializarlo
